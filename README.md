...
Коллбэк простая конструкция в программировании и выполняет полезных действий. Основным плюсом использовать callback-функции - это способ расширения функционала, элемент проектирования функций. Однако callback-функции бывают как синхронные, так и ассинхронные.
...
Функция pipe принимает callback функции, агрегирует их и на каждую букву в строке вызывает функции. С помощью такого подхода эффективно решать многие синхронные задачи.
