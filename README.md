...
```
С помощью такого подхода эффективно решать многие синхронные задачи. Код построенный на callback-функциях в купе с замыканием дает возможность писать локаничный и довольно императивный код. В
